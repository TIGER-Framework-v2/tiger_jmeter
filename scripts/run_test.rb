...
Dir.chdir("/#{tests_repo_name}/#{test_type}")
test_settings_hash=YAML.load(File.read("/#{tests_repo_name}/#{test_type}/#{test_type}.yml"))
test_results_folder="/opt/tiger/#{test_type}"
