...
backend_listener_file_name="InfluxBackendListenerClient.jar"
...
wget -O /opt/tiger/temp/$backend_listener_file_name $backend_listener_url
adduser -D -u 1001 tiger 
chown -R tiger /opt/tiger
mv /opt/tiger/temp/$backend_listener_file_name /opt/$JM_NAME/lib/ext
